...
import { patchStore } from './patchRedux';
...
// Another benefit is, that the YDoc can be used for other purposes than the redux store. (except for the "__ReduxMiddlewareRootMap" map).
//
